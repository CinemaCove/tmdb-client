type ConfigurationImages = {
    readonly base_url: string; // example: http://image.tmdb.org/t/p/
    readonly secure_base_url: string; // example: https://image.tmdb.org/t/p/
    readonly backdrop_sizes: string[]; // example: w300
